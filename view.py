...
SPRITE_BONUS_ITEMS = [ "images/misc/star.png", "images/misc/push.png"]
...
class GraphicView:
    ...
    def __init__(self, model, playername = ""):
        ...
        self.sprite_bonus_items = [ pygame.image.load(sprite).convert_alpha() for sprite in SPRITE_BONUS_ITEMS ]
    ...
    # render fruit view
    def render_items(self, item):
        x = item.pos[X] * SPRITE_SIZE
        y = item.pos[Y] * SPRITE_SIZE
        self.win.blit(self.sprite_bonus_items[item.kind], (x, y))
